...
export const NetworkSummaryCard: React.FC<NetworkSummaryCardProps> = ({ stats }) => {
  return (
    <div className="bg-[#1a1f2e] border border-blue-900/30 rounded-xl overflow-hidden font-mono text-[11px] mb-6 shadow-xl">
      ...
      <div className="p-5 flex gap-3 overflow-x-auto custom-scrollbar pb-3">
        {/* Total Unique Box */}
        <div className="bg-[#1e2536] border border-blue-900/50 rounded-lg p-4 flex flex-col justify-center items-center min-w-[140px] shrink-0">
        ...
        {OPERATORS.map(op => {
          ...
          return (
            <div key={op.key} className="bg-[#1e2536] border border-blue-900/50 rounded-lg p-4 flex flex-col justify-center items-center min-w-[100px] shrink-0">
        ...
        {OPERATORS.map(op => {
          ...
          return (
            <div key={op.key} className="flex items-center gap-4">
              ...
              <div className="flex-1 h-3 bg-[#0f141e] rounded-full overflow-hidden flex items-center">
                <div 
