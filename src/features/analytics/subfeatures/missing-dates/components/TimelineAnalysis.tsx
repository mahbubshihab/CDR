  ...
  return (
    <div className="flex flex-col gap-6 max-w-6xl mx-auto w-full">
        ...
        <div className="bg-[#121212] border border-[#2e2e2e] rounded-lg p-5">
          ...
          <div className="space-y-2 max-h-[500px] overflow-y-auto custom-scrollbar pr-2">
            {activePeriods.map((p, i) => (
              <div key={i} className="bg-[#1c1c1c] border border-[#2e2e2e] rounded p-3 text-sm text-gray-300 flex items-center gap-2">
      ...
      <div className="grid grid-cols-4 gap-4 mt-2">
        <div className="bg-[#121212] border border-[#2e2e2e] rounded-lg p-5 flex flex-col items-center justify-center text-center">
