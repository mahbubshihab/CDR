...
export const IntlTimelineView: React.FC<IntlTimelineViewProps> = ({ records }) => {
  ...
  return (
    <div className="bg-[#1e293b] border border-[#334155] rounded-xl p-5 mt-6 animate-in fade-in duration-300">
      <h3 className="text-sm font-semibold text-gray-200 mb-6">Chronological Activity Timeline</h3>
      
      {timelineData.length > 0 ? (
        <div className="relative h-48 w-full border-b border-l border-[#334155] px-2 pb-2">
          {timelineData.map((d, i) => {
            ...
            return (
              ...
              >
                <div className="hidden group-hover:block absolute bottom-full mb-2 left-1/2 -translate-x-1/2 bg-[#0f172a] border border-[#334155] p-2 rounded shadow-xl whitespace-nowrap z-10 text-xs">
