...
export const IntlContactsView: React.FC<IntlContactsViewProps> = ({ records }) => {
  ...
  return (
    <div className="bg-[#1e293b] border border-[#334155] rounded-xl overflow-hidden mt-6 animate-in fade-in duration-300">
      <div className="p-4 border-b border-[#334155] bg-[#0f172a]/50 flex justify-between items-center">
        ...
        <div className="relative group">
          ...
          <input
            ...
            className="bg-[#0f172a] border border-[#1e293b] text-gray-200 text-xs rounded pl-8 pr-3 py-1.5 focus:outline-none focus:border-[#38bdf8] focus:ring-1 focus:ring-[#38bdf8] transition-all w-48 placeholder:text-gray-600"
          />
        </div>
      </div>
