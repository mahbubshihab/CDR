...
export const CountryMapSummary: React.FC<CountryMapSummaryProps> = ({ countries }) => {
  ...
  return (
    <div className="bg-[#1c1c1c] border border-[#2e2e2e] rounded-xl overflow-hidden mt-6 mb-10">
      ...
      <div className="p-5 flex flex-wrap gap-3">
        {countries.map((c) => (
          <div 
            key={c.country} 
            className="flex items-center gap-2 bg-[#121212] border border-[#2e2e2e] rounded-md py-1.5 px-3"
          >
            <span className="text-[10px] font-bold text-[#38bdf8] bg-[#121212] border border-[#38bdf8]/30 px-1.5 py-0.5 rounded uppercase tracking-wider">
              {c.code}
            </span>
