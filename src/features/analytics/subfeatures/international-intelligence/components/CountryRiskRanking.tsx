...
export const CountryRiskRanking: React.FC<CountryRiskRankingProps> = ({ countries }) => {
  ...
  return (
    <div className="bg-[#1e293b] border border-[#334155] rounded-xl overflow-hidden mt-6">
      {/* Header */}
      <div className="p-4 border-b border-[#334155] flex flex-col sm:flex-row sm:items-center justify-between gap-4 bg-[#0f172a]/50">
        ...
        <div className="flex items-center gap-3">
          <div className="relative group">
            ...
            <input
              ...
              className="bg-[#0f172a] border border-[#1e293b] text-gray-200 text-xs rounded pl-8 pr-3 py-1.5 focus:outline-none focus:border-[#38bdf8] focus:ring-1 focus:ring-[#38bdf8] transition-all w-40 placeholder:text-gray-600"
            />
          </div>
          <button className="bg-[#0f172a] border border-[#1e293b] hover:border-gray-500 text-gray-300 text-xs px-3 py-1.5 rounded transition-colors font-medium">
            Columns
          </button>
      ...
      <div className="overflow-x-auto custom-scrollbar">
        <table className="w-full text-left text-xs">
          <thead>
            <tr className="border-b border-[#334155] text-gray-400 font-semibold bg-[#172136]">
